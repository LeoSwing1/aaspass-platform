...
const schema = z.object({
    ...
    ALLOWED_ORIGINS: stringFromEnv(z.string().default('http://localhost:3000,http://localhost:5173')),
    ...
    FCM_PRIVATE_KEY: stringFromEnv(z.string().optional()),
    KYC_PROVIDER: stringFromEnv(z.string().default('not-configured')),
    ...
    WHATSAPP_ACCESS_TOKEN: stringFromEnv(z.string().optional()),
    DELIVERY_OTP_SECRET: stringFromEnv(z.string().min(32).default('dev-only-delivery-otp-secret-change-this-secret-before-production-123456789')),
});
